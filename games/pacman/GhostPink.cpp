//
// GhostPink.cpp for  in /home/tetard/EPITECH_Y2/CPP/cpp_arcade/games/pacman
//
// Made by benjamin girard
// Login   <tetard@epitech.net>
//
// Started on  Sat Apr  8 16:06:26 2017 benjamin girard
// Last update Sun Apr  9 14:03:15 2017 benjamin girard
//
...
GhostPink::GhostPink(const arcade::Position &pos, const t_drawer &sprite, const std::string &path) :
  AGhost(pos, sprite, path) {}

GhostPink::GhostPink(const GhostPink &cp) : AGhost(cp.getPos(), cp.getSprite(), cp.getPath()) {}

void					GhostPink::move(const std::vector<arcade::TileType> &map)
{
