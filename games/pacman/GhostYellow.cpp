//
// GhostYellow.cpp for  in /home/tetard/EPITECH_Y2/CPP/cpp_arcade/games/pacman
//
// Made by benjamin girard
// Login   <tetard@epitech.net>
//
// Started on  Sat Apr  8 16:06:26 2017 benjamin girard
// Last update Sun Apr  9 14:05:05 2017 benjamin girard
//
...
GhostYellow::GhostYellow(const arcade::Position &pos, const t_drawer &sprite, const std::string &path) :
  AGhost(pos, sprite, path) {}

GhostYellow::GhostYellow(const GhostYellow &cp) : AGhost(cp.getPos(), cp.getSprite(), cp.getPath()) {}

void					GhostYellow::move(const std::vector<arcade::TileType> &map)
{
